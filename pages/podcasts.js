...
import { getAllPostsForHome, getSubscribeModal, getSubscriberBenefits, getPodcastPageMetaData, getMenuItems } from '../lib/api'
import useScript from '../hooks/useScript';

import { GlobalProvider } from '../context/GlobalState'

export default function Index({ allPosts, subscribeModalData, subscriberBenefitsData, podcastMetaDataData, menuItemsData }) {
...
export async function getStaticProps({ preview = false, subscribeModalData, subscriberBenefitsData, podcastMetaDataData, menuItemsData }) {
